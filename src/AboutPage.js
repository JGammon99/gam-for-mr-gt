  ...
  return (
    <div className="page-container">
        ...
        <div className='about-text'>
            <p>Mr. GT is a male pageant that has the goal of raising money for Send Me Now Missions! Leading up to the actual event on March 8th, competitors work together with their coaches to fundraise money for their campaign! On the night of March 8th, the competitors
